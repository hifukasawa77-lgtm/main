...
**学びを CLAUDE.md や docs へ直接書いた日も、Daily を1本残す**（何を学び、どこへ書いたかの
1〜2行でよい）。直接昇格させると Vault に痕跡が残らず、harness-lint 検査#9 が
「作業したのに記録が無い日」として警告し続ける——2026-09-01 と 09-05 がこれで
12日間・3回の /self-improve にわたって警告され、そのたびに無視された。
**無視される警告は、あるだけ害**。記録の置き場所は1つに決め、必ず痕跡を残すこと。
