...
### 1.2 `kyoten_ichi.csv` — 拠点の正本（147拠点）

スキーマは基本設計 3.3 のとおり。**座標は正規化 `MX,MY`（0..1・小数6桁）**。

内訳: **国衙66 ／ 荘園40 ／ 館・城郭25 ／ 湊16 ＝ 147**
...
```
入力: siro_ichi.csv（戦国の城164。X,Y は地図画素座標・地図は 1672×941）
手順:
  1. 各拠点に「アンカー城」（同国または隣国の既知の城）を1〜3件割り当てる
  2. アンカー1件のとき: anchor + 手動オフセット(dx,dy) を画素で与える
     アンカー2件以上のとき: 距離の逆数で重み付けした加重平均に補正を掛ける
  3. 得られた画素座標を MX = x/1672, MY = y/941 で正規化して出力
検証:
  - 全拠点が陸地上（湊は海岸線から 12px 以内）にあること
  - 拠点どうしの最短間隔が 11px 以上（戦国風雲記で確認済みの下限）
```

> `siro_ichi.csv` の X,Y は地図画像 1672×941 の画素座標。**`gen-genpei-kyoten.mjs` は
> `siro_ichi.csv` を読むだけで、書き戻さない**（`sengoku.html` 側の資産を汚さない）。
...
| 東海 | 伊豆国衙 | 伊豆韮山城 |
| 東海 | 甲斐国衙 | 躑躅ヶ崎館 |
| 東海 | 相模国衙 | 小机城（西へオフセット＝平塚）|
| 東海 | 武蔵国衙 | 江戸城（西へオフセット＝府中）|
| 東海 | 安房国衙 | 館山城 |
| 東海 | 上総国衙 | 真里谷城 |
| 東海 | 下総国衙 | 関宿城（南へオフセット＝市川）|
| 東海 | 常陸国衙 | **府中城**（＝国府そのもの）|
| 東山 | 近江国衙 | 観音寺城（西へオフセット＝大津）|
| 東山 | 美濃国衙 | 稲葉山城 |
| 東山 | 飛騨国衙 | 松倉城 |
| 東山 | 信濃国衙 | **深志城**（＝松本・国府）|
| 東山 | 上野国衙 | 箕輪城 |
...
| 山陰 | 出雲国衙 | 月山富田城 |
| 山陰 | 石見国衙 | 山吹城 |
| 山陰 | 隠岐国衙 | 月山富田城（北へ大きくオフセット＝隠岐島）|
| 山陽 | 播磨国衙 | 姫路城 |
| 山陽 | 美作国衙 | 津山城 |
| 山陽 | 備前国衙 | 岡山城 |
| 山陽 | 備中国衙 | 備中高松城 |
| 山陽 | 備後国衙 | 神辺城 |
| 山陽 | 安芸国衙 | 吉田郡山城（南へオフセット＝府中）|
| 山陽 | 周防国衙 | 山口館 |
| 山陽 | 長門国衙 | 櫛崎城 |
| 南海 | 紀伊国衙 | 雑賀城 |
| 南海 | 淡路国衙 | 洲本城 |
...
| 南海 | 伊予国衙 | 湯築城 |
| 南海 | 土佐国衙 | 岡豊城 |
| 西海 | 豊前国衙 | 小倉城（南へオフセット＝京都郡）|
| 西海 | 豊後国衙 | 府内館（＝国府）|
| 西海 | 筑前国衙 | 立花山城（南西へオフセット＝太宰府）|
| 西海 | 筑後国衙 | 柳川城 |
| 西海 | 肥前国衙 | 佐賀城 |
| 西海 | 肥後国衙 | 隈本城 |
| 西海 | 日向国衙 | 佐土原城 |
