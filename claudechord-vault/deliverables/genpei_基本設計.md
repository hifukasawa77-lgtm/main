...
| RetsudenScene（Phase 5 実装済） | 人物列伝。存命の武将50＋前史の人々8。肖像・家紋・能力6項目・一行の来歴 |

> **アセットは一切使わず Canvas だけで描く**（拠点アイコン11種・家紋5種・肖像）。
> 画像に依存しないので、後読みの失敗で白い箱になることがない。
> - 家紋: 平氏＝揚羽蝶／源氏＝笹竜胆／北条＝三つ鱗／奥州藤原＝下がり藤／朝廷＝菊
> - 肖像: 勢力色の大鎧を基調に、**家格で烏帽子・吹返し・鍬形が変わり**、騎射で目つきが鋭くなり、
>   太刀で眉が太く髭が生える。同じ顔が並ばず、能力が見た目に出る
>
