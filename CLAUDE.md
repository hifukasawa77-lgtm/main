...
- **日本地図だけは高精細版（2倍）を併せ持つ**。原画 `sengoku-japan-map-user-v1.webp` は 1672×941 しかなく、
  ...
  そこで `sengoku-japan-map-user-v1-detail.webp`（3344×1882・Lanczos＋弱アンシャープ）を
  ...
  **この1枚だけは「解像度を変えない」原則の例外**（背景描画は縦横比だけで配置を決めるため source-rect が壊れない）。
  縮小・再エンコードして等倍に戻すとぼやけが再発する。アンシャープを強めるとハローが17倍に拡大されて
  森が黒く潰れるため、強度を上げたら必ず高ズームのスクリーンショットで輪郭を確認すること
