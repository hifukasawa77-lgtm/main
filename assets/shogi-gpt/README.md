# AI Shogi GPT-image-2 Assets

Generated with the built-in GPT-image-2 image tool for the AI Shogi game.

- `shogi-board-gpt-image-2.png` - 9x9 shogi board texture used by `shogi.html`
- `shogi-board-playfield.png` - cropped 9x9 playfield used for exact CSS-cell alignment
- `shogi-piece-base.png` - blank shogi piece face used under live piece text
- `shogi-piece-promoted.png` - blank promoted-piece face used under promoted/live special states
