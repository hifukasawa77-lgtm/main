...
(function (root, factory) {
  if (typeof module === 'object' && module.exports) {
    ...
    root.AGENT_DATA = factory();          // ブラウザ
      ...
      // ── Game Registry ────────────────────────────────────────
      const GAMES = [
        { slug:'black-fang', href:'beat_em_up.html', cat:'action', thumb:'assets/black-fang/black-fang-thumb.webp',
        ...
        { slug:'zelda', href:'zelda_like.html', cat:'rpg', thumb:'assets/zelda-like/kenney_roguelike-rpg-pack/Sample1.webp',
        ...
        { slug:'shogi', href:'shogi.html', cat:'board', thumb:'assets/shogi-gpt/shogi-thumb-gpt-image-2.webp',
        ...
        { slug:'chess', href:'chess.html', cat:'board', thumb:'assets/chess-gpt/chess-thumb-gpt-image-2.webp',
        ...
        { slug:'go', href:'go.html', cat:'board', thumb:'assets/go-gpt/go-thumb-gpt-image-2.webp',
        ...
        { slug:'backgammon', href:'backgammon.html', cat:'board', thumb:'assets/backgammon/backgammon-thumb-gpt-image-2.webp',
        ...
        { slug:'estate-tycoon', href:'estate-tycoon.html', cat:'board', thumb:'assets/estate-tycoon-gpt/estate-thumb-gpt-image-2.webp',
        ...
        { slug:'ludo', href:'ludo.html', cat:'board', thumb:'assets/ludo/ludo-thumb-gpt-image-2.webp',
        ...
        { slug:'checkers', href:'checkers.html', cat:'board', thumb:'assets/checkers/checkers-thumb.webp',
        ...
        { slug:'hex', href:'hex.html', cat:'board', thumb:'assets/hex/hex-thumb.webp',
        ...
        { slug:'sanguo', href:'sanguo.html', cat:'sim', thumb:'assets/sanguo/gpt/scenarios/sanguo-scenario-190-anti-dong-zhuo-gpt-image-2.webp',
          title:{ja:'三国志・天下三分',en:'Sanguo: Three Kingdoms'}, emoji:'🀄',
          desc:{ja:'8シナリオ・10勢力の三国志戦略SLG。内政・登用・外交・計略とヘックス合戦',en:'Three Kingdoms strategy sim: 8 scenarios, 10 factions, hex battles'},
          aliases:{ja:['三国志','さんごくし','サンゴクシ','天下三分','曹操','劉備','孫権','諸葛亮','呂布','関羽','赤壁','戦略シミュレーション','歴史シミュレーション','slg'],
                   en:['sanguo','three kingdoms','sangokushi','cao cao','liu bei','sun quan','zhuge liang','lu bu','red cliffs','strategy sim']} },
        { slug:'sengoku', href:'sengoku.html', cat:'sim',
          title:{ja:'戦国風雲記',en:'Sengoku Fuunki'}, emoji:'🏯',
          desc:{ja:'日本戦国の大名で天下統一を目指す戦略SLG。街道・城・攻城ヘックス戦',en:'Japanese Sengoku strategy sim with roads, castles and hex sieges'},
          aliases:{ja:['戦国','せんごく','風雲記','大名','天下統一','信長','織田','武田','上杉','城','攻城','日本史'],
                   en:['sengoku','warring states','daimyo','nobunaga','japan strategy','castle siege']} },
        { slug:'genpei', href:'genpei.html', cat:'sim', thumb:'assets/genpei/genpei-thumb.webp',
          title:{ja:'源平争乱記',en:'Genpei Souranki'}, emoji:'🏹',
          desc:{ja:'治承・寿永の乱1180-1189の歴史SLG。兵力ではなく名分（院宣・官位・三種の神器）を獲る',en:'Genpei War strategy sim 1180-1189: win legitimacy, not castles'},
          aliases:{ja:['源平','げんぺい','源平合戦','争乱記','治承','寿永','頼朝','源頼朝','義経','源義経','木曽義仲','平清盛','平氏','平家','鎌倉','壇ノ浦','屋島','一ノ谷','奥州藤原','名分','歴史シミュレーション'],
                   en:['genpei','genpei war','yoritomo','yoshitsune','kiso yoshinaka','taira','minamoto','heike','dan-no-ura','kamakura','legitimacy']} },
        { slug:'taihei', href:'taihei.html', cat:'sim', thumb:'assets/taihei/taihei-thumb.webp',
          title:{ja:'太平風雲記',en:'Taihei Fuunki'}, emoji:'⚖️',
          desc:{ja:'元弘の乱〜南北朝合一1331-1392の歴史SLG。朝廷・恩賞・悪党で忠誠と正統性を奪い合う',en:'Nanboku-chō era strategy sim 1331-1392: contest loyalty and court legitimacy'},
          aliases:{ja:['太平風雲記','たいへいふううんき','南北朝','太平記','元弘の乱','後醍醐天皇','足利尊氏','新田義貞','楠木正成','北朝','南朝','朝廷','忠義','悪党','歴史シミュレーション'],
                   en:['taihei fuunki','nanboku-cho','northern and southern courts','go-daigo','ashikaga takauji','nitta yoshisada','kusunoki masashige','loyalty','legitimacy']} },
        ...
        { slug:'corridor', href:'corridor.html', cat:'board', thumb:'assets/corridor/corridor-thumb.webp',
