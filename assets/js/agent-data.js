    ...
    root.AGENT_DATA = factory();          // ブラウザ
      ...
      const GAMES = [
        ...
        { slug:'catan', href:'catan.html', cat:'board',
          ...
          desc:{ja:'資源を集め開拓地を建設、1人vsAI3体でVP10点を狙うカタン風ボード',en:'Catan-style board — gather resources, build settlements, race AI to 10 VP'},
          aliases:{ja:['hexlan','ヘックスラン','カタン','かたん','開拓者'],en:['hexlan','catan','settlers of catan']} },
        { slug:'blokus', href:'blokus.html', cat:'board',
          title:{ja:'テトラ陣地',en:'Tetra Territory'}, emoji:'🟥',
          desc:{ja:'20×20にポリオミノを置き角タッチで陣地を広げるブロックス風AI対戦',en:'Blokus-style AI board — place polyominoes and expand via corner touches'},
          aliases:{ja:['テトラ陣地','ブロックス','ぶろっくす','ポリオミノ'],en:['tetra territory','blokus','polyomino']} },
        { slug:'blokus-trigon', href:'blokus_trigon.html', cat:'board',
          title:{ja:'トライ陣地',en:'Tri Territory'}, emoji:'🔺',
          desc:{ja:'三角ピースをひし形盤に敷き詰める角タッチのAI対戦ゲーム',en:'Trigon Blokus — fill a rhombus board with triangular pieces'},
          aliases:{ja:['トライ陣地','トライゴン','三角ブロックス'],en:['tri territory','trigon','blokus trigon']} },
        { slug:'iroha-karuta', href:'iroha_karuta.html', cat:'card', thumb:'assets/karuta-gpt/iroha-thumb-gpt-image-2.png',
          title:{ja:'いろはかるた',en:'Iroha Karuta'}, emoji:'🎴',
          desc:{ja:'江戸いろは48枚。読み札を聞いて正しい絵札を取る伝統かるた',en:'Traditional Edo Iroha karuta — hear the reading, grab the right card'},
          aliases:{ja:['いろはかるた','いろは','江戸かるた','いろは歌'],en:['iroha karuta','iroha']} },
        { slug:'kart-racer', href:'kart_racer.html', cat:'action',
          title:{ja:'ターボカート・グランプリ',en:'Turbo Kart Grand Prix'}, emoji:'🏎️',
          desc:{ja:'擬似3D三人称のカートレース。ドリフトでミニターボ、アイテムでライバル5台を抜け',en:'Pseudo-3D kart racing — drift for mini-turbo and use items to beat 5 rivals'},
          aliases:{ja:['ターボカート','カート','カートレース','グランプリ','マリオカート'],en:['turbo kart','kart','kart racer','racing','grand prix']} },
        { slug:'pinball', href:'pinball.html', cat:'action',
          title:{ja:'NEON PINBALL',en:'Neon Pinball'}, emoji:'🕹️',
          desc:{ja:'重力と反射の物理エンジンで遊ぶ縦型ピンボール。左右フリッパーでバンパーを狙え',en:'Physics-based vertical pinball — work the flippers and hit the bumpers'},
          aliases:{ja:['ピンボール','ぴんぼーる','ネオンピンボール','フリッパー'],en:['pinball','neon pinball','flipper']} },
      ];
